...
with open('recursive_feature_selection_all_metrics_test_train.csv', 'a+') as csvfile:
    ...
    writer = csv.DictWriter(csvfile, fieldnames = ["Classifier", "TrainAccuracy", "TrainRecall", "TrainSpecificity", "TrainauROC", "TrainauPR", "TestAccuracy", "TestRecall", "TestSpecificity", "TestauROC", "TestauPR", ])
    writer.writeheader()
    ...
    for fstt in range(0,n_features,1):
        ...
        if(n_features-fstt == 29823): #the best feature set = 29823
            ...
            csvfile.write("{0:3.6},{1:3.6},{2:3.6},{3:3.6},{4:3.6}\n".format(test_acc_score_rf*100, np.mean(test_recall_score_rf), np.mean(test_specificity_rf),test_auroc_score_rf, test_auPR_score_rf ))
            ...
            csvfile.write("{0:3.6},{1:3.6},{2:3.6},{3:3.6},{4:3.6}\n".format(test_acc_score_ext*100, np.mean(test_recall_score_ext), np.mean(test_specificity_ext), test_auroc_score_ext, test_auPR_score_ext))
            ...
            csvfile.write("{0:3.6},{1:3.6},{2:3.6},{3:3.6},{4:3.6}\n".format(test_acc_score_sv*100, np.mean(test_recall_score_sv), np.mean(test_specificity_sv), test_auroc_score_sv, test_auPR_score_sv))
            ...
            csvfile.write("{0:3.6},{1:3.6},{2:3.6},{3:3.6},{4:3.6}\n".format(test_acc_score_lr*100, np.mean(test_recall_score_lr), np.mean(test_specificity_lr), test_auroc_score_lr, test_auPR_score_lr))
            ...
            csvfile.write("{0:3.6},{1:3.6},{2:3.6},{3:3.6},{4:3.6}\n".format(test_acc_score_adab*100, np.mean(test_recall_score_adab), np.mean(test_specificity_adab), test_auroc_score_adab, test_auPR_score_adab))
            ...
            csvfile.write("{0:3.6},{1:3.6},{2:3.6},{3:3.6},{4:3.6}\n".format(test_acc_score_dt*100, np.mean(test_recall_score_dt), np.mean(test_specificity_dt), test_auroc_score_dt, test_auPR_score_dt))
            ...
            csvfile.write("{0:3.6},{1:3.6},{2:3.6},{3:3.6},{4:3.6}\n".format(test_acc_score_nb*100, np.mean(test_recall_score_nb), np.mean(test_specificity_nb), test_auroc_score_nb, test_auPR_score_nb))
            ...
            csvfile.write("{0:3.6},{1:3.6},{2:3.6},{3:3.6},{4:3.6}\n".format(test_acc_score_knn*100, np.mean(test_recall_score_knn), np.mean(test_specificity_knn), test_auroc_score_knn, test_auPR_score_knn))
            ...
            csvfile.write("{0:3.6},{1:3.6},{2:3.6},{3:3.6},{4:3.6}\n".format(test_acc_score_lda*100, np.mean(test_recall_score_lda), np.mean(test_specificity_lda), test_auroc_score_lda, test_auPR_score_lda))
